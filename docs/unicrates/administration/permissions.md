...
| `unicrates.command.studio` | Permission to access the visual Animation Studio (`/crate studio`). | OP Level 2 |
...
| Permission Node | Description | Default Level |
| :--- | :--- | :--- |
| `unicrates.bypass.cost` | Open crates and test mass open without consuming physical or virtual keys. | OP Level 2 |
...
| `unicrates.command.massopen` | Allows using `/crate massopen <id>` command. | All Players |
